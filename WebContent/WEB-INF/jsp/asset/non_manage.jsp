            ...
            <div class="col-md-12" style="padding-left: 8px;padding-right: 8px">
                <div class="panel panel-default">
                    <div class="panel-heading bk-bg-primary">
                        <h2><i class="fa fa-indent red"></i><strong>非固定资产管理</strong></h2>
                    </div>
                    <div class="panel-body">
                        <form action="" method="post" class="form-horizontal" role="form">
                            <div class="form-group">
                                ...
                                <label class="col-md-1 control-label">使用者</label>
                                <div class="col-md-3">
                                    <select class="form-control">
                                        <option>全部</option>
                                        <option>电子产品</option>
                    ...
                    <div class="panel-footer">
	                     <form action="" method="post" class="form-horizontal" role="form">
                            <div class="form-group">
                            	<div class="col-md-2">
                                	<button type="button" class="btn btn-info"><i class="fa fa-search-plus"></i> 资产列表</button>
                                </div>
                                <div class="col-md-2">
