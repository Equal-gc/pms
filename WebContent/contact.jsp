    ...
    <div class="container">
        <div class="head-top">
            ...
            <div class="col-md-6 h-right">
                <ul>
                    <li><a href="http://demo.cssmoban.com/cssthemes4/cpts_593_bam/contact.html#"><span class="fb"> <font size="2" color="white">登陆</font></span></a></li>
                    <li><a href="http://demo.cssmoban.com/cssthemes4/cpts_593_bam/contact.html#"><span class="twit"><font size="2" color="white">注册</font> </span></a></li>
                    <li><a href="http://demo.cssmoban.com/cssthemes4/cpts_593_bam/contact.html#"><span class="pin"> </span></a></li>
                    <li><a href="http://demo.cssmoban.com/cssthemes4/cpts_593_bam/contact.html#"><span class="rss"> </span></a></li>
                </ul>
            </div>
            ...
            <div class="head-right">
                <div class="top-nav">
                    ...
                    <ul>
                        ...
                        <li><a href="contact.jsp" class="active"><span class="glyphicon glyphicon-envelope"></span>Contact</a></li>
                        <div class="clearfix"> </div>
                    </ul>
                    <!--script-->
                    <script>
...
<div class="contact">
    <div class="container">
        ...
        <div class="map">
            <iframe src="./Contact_files/embed.html" style="border:0" allowfullscreen=""></iframe>
        </div>
...
<div class="footer">
    <div class="container">
        <div class="footer-top">
            ...
            <a href="http://demo.cssmoban.com/cssthemes4/cpts_593_bam/contact.html#home" class="scroll"><img src="./assets/png/top-arrow.png" alt=""></a>
        </div>
    </div>
</div>
<!--footer-end-->
