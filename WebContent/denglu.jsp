...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript" src="./assets/js/a_denglu.js"></script>
...
<div style="padding: 100px 100px 10px;" align="center">
    ...
    <center><h3> 用户登录</h3></center><br><br><br>
        <div class="input-group input-group-lg">
            <span class="input-group-addon" style="width:50px;height:50px;"><i class="glyphicon glyphicon-user"></i></span>
            <input type="text" class="form-control" style="width:300px;height:50px;font-size:18px" id="username" placeholder="用户名">
        </div><br>
        <div class="input-group">
            <span class="input-group-addon"  style="width:50px;height:50px;"><i class="glyphicon glyphicon-lock"></i></span>
            <input type="password" class="form-control" style="width:300px;height:50px;font-size:18px" id="password" placeholder="密 码">
        </div><br><br>
        <input type="button" style="width:200px;height:40px;border-radius:25px;background:#C0C0C0" onclick="login()" value="登 陆">
    <input type="button" style="width:200px;height:40px;border-radius:25px;background:#C0C0C0" onclick="getUserInfo('gc')" value="用户信息">
</div>
<div class="address">
    <div class="container">
